...
# sampleText1a = sampleText1.format("Christine", "Burger", "Mobile Legends", "Grapes")
# print(sampleText1a)



# sampleText2 = "My name is {1}. I love {2}. I love playing {0}."
# sampleText2a = sampleText2.format("COD", "Ivann", "Pizza", "Frisbee", "Grapes")
# print(sampleText2a)



# sampleText3 = "My name is {name}. I love {food}. I love playing {play}."
# sampleText3a = sampleText3.format(food="Pizzar", play="Frisbee", name="Ivann")
# print(sampleText3a)
